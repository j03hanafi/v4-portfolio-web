      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            <p>
              I also experienced in designing and building web and mobile Geographic Information
              System Applications using Figma, PHP, MySQL, and Basic4Android, as well as integrating
              spatial functionalities using Google Maps API.
            </p>

            <p>
              I have designed a web app integrating farming activities with a B2B marketplace,
              mentoring with experts, forum, and information features using Figma, PHP and MySQL.
            </p>
